...
const addBlogToPlaylist = asyncHandler(async (req, res) => {
    ...
    return res
        .status(200)
        .json(new ApiResponse(200, playlist, "Blog added to playlist successfully"));
});
...
const removeBlogFromPlaylist = asyncHandler(async (req, res) => {
    ...
    return res
        .status(200)
        .json(new ApiResponse(200, playlist, "Blog removed from playlist successfully"));
});
...
const searchPlaylists = asyncHandler(async (req, res) => {
    ...
    return res
        .status(200)
        .json(new ApiResponse(200, playlists, "Playlists search results"));
});
